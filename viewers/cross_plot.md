...
* ![](../.gitbook/assets/001_crossplot.png): Interactive swapping between density and scatter plots can be done using the **scatter plot** icon
* ![](../.gitbook/assets/002_crossplot.png): and between single and histogram colour display using the **single colour / dataset** icon.
* ![](../.gitbook/assets/003_crossplot.png): Focusing the plot for the visible data range, is possible using the **Recalculate plot** icon. It is also possible to select the option to auto-recalculate the plots for visible range.
...
A 3rd volume can be selected to color the data points in the cross plot display, when in scatter plot and histogram coloring mode.
...
![](../.gitbook/assets/jk36manual_-v3.png)

_LFC, density plot : cursor readout LFC, scatter plot : cursor readout_  ![](../.gitbook/assets/004_crossplot.png)  _PCube LFC facies classes & volumes shown together in a scatter cross plot, of Vp v Vp/Vs with point colours from the 3rd density attribute. \(Imported ASCII file LFC values are shown instead of simulated clouds\)._
...
![](../.gitbook/assets/005_crossplot.PNG)
...
![](../.gitbook/assets/006_crossplot.png)
...
![](../.gitbook/assets/007_crossplot.PNG)

_Gathers before and after AGC scaling and corresponding crossplot_  __![](../.gitbook/assets/008_crossplot.PNG) _\_Single colour V Full colour density display_
...
![](../.gitbook/assets/009_crossplot.png)
...
![](../.gitbook/assets/010_crossplot.png)
...
![](../.gitbook/assets/011_crossplot.PNG) _Single colour V Full colour density plot display_
...
![](../.gitbook/assets/012_crossplot.PNG)
...
![](../.gitbook/assets/013_crossplot.png)

LFC datasets can be added to the crossplot using the **Add/Edit Facies** option in the Cross Plot window. The user has a choice of running simulations to prod uce point clouds for each selected LFC or replacing these simulation with imported real Vp/Vs/Rho values if available.

![](../.gitbook/assets/014_crossplot.png) _Add/Edit Facies – Select Facies Input GUI_
...
![](../.gitbook/assets/015_crossplot.PNG) _Add/Edit Facies – Axis select, 15 properties available_ 

![](../.gitbook/assets/016_crossplot.PNG) _PCube LFC classes – simulated clouds V imported ASCII points \(red cloud/points are from PCube inversion output volumes\)_

### Cross Plot window - basics and icons

![](../.gitbook/assets/slide1.png)

![](../.gitbook/assets/017_crossplot.PNG)

## Cross Plot window - context menus & polygons

![](../.gitbook/assets/018_crossplot.png)
...
![](../.gitbook/assets/xplots-36-13.png)

## Cross Plot window - context menus & overlays

![](../.gitbook/assets/xplots-36-14.png)
...
To adjust the angle of the overlay properly, make sure that the ratio between each axis is 1:1. You can use the ![](../.gitbook/assets/019_crossplot.png) button in the tool bar to ensure that the ratio is properly set.

## Mask volumes :

Mask volumes can be created from ‘visible points’, using the main Cross Plot window icon ![](../.gitbook/assets/crossplt13a.png) or from polygons created in the cross-plot window.

![](../.gitbook/assets/xplots-36-15.png)
...
![](../.gitbook/assets/020_crossplot.png)
...
![](../.gitbook/assets/crossplt19a.png)

_Masks – display points inside polygons as colours_

![](../.gitbook/assets/021_crossplot.PNG) _Left: Seismic input to Cross Plot - Right: 3 Mask volumes overlain \(inverse\)_
...
![](../.gitbook/assets/022_crossplot.png)

_Custom mathematical equation for a 3 class volume_

![](../.gitbook/assets/023_crossplot.PNG)
