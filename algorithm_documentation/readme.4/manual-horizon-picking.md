...
![MHP Hotkeys](../../.gitbook/assets/mhp_hotkeys.jpg)
...
There is an option to **Send to Horizon Tools for gridding** which will save the horizon to the project AND automatically open Horizon Tools with the manual horizon loaded. For manual picked horizons with an input horizon there is an additional option to merge the picks, with user controlling the merge options. 

![Sending horizons to Horizon Tools for gridding/editing](../../.gitbook/assets/mhp_sendtohtools.png)

![Manual horizon is opened in Horizon Tools](../../.gitbook/assets/mhp_sendtohtools2.png)
