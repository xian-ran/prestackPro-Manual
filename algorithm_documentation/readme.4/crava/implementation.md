...
![The frequency content of the seismic traces in two different well. ](../../../.gitbook/assets/image%20%2822%29.png)
...
![Well logs aligned according to true time scale \(left\) and according to stratigraphic depth \(right\).](../../../.gitbook/assets/image%20%281%29.png)
...
![Well log values plotted against grid layer number for Vp \(top\) and rho \(bottom\). The blue circles show log values, the green curve is a piecewise linear regression of the these values, and the red curve is the regression values filtered to 6Hz.](../../../.gitbook/assets/image%20%2817%29.png)

![](../../../.gitbook/assets/image%20%2832%29.png)

![Vp depth trend \(top\) and final background model \(bottom\). ](../../../.gitbook/assets/image%20%2826%29.png)
...
![The local scale and shift maps involved when using local wavelets](../../../.gitbook/assets/image%20%2821%29.png)
